          ...
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="pt-4 border-t border-neutral-100">
              ...
              <div className="flex gap-4 items-start">
                <div className="shrink-0 w-24 h-24 border border-neutral-300 bg-neutral-50 overflow-hidden relative group">
                  {(conf.image || b.image) &&
                    ((conf.image || b.image).toLowerCase().match(/\.(mp4|webm|mov)$/) ? (
                      <video
                        src={conf.image || b.image || undefined}
                        key={conf.image || b.image}
                      ...
                      <img
                        src={conf.image || b.image || undefined}
                        key={conf.image || b.image || undefined}
                        className="w-full h-full object-cover transition-transform group-hover:scale-105"
                        alt="Preview"
            ...
            {b.id === "about_me" && (
              <div className="mt-6 pt-4 border-t border-neutral-150">
                ...
                <div className="flex gap-2">
                  <div className="shrink-0 w-12 h-12 border border-neutral-300 bg-neutral-100 overflow-hidden relative">
                    {(conf.authorImage || b.image) && (
                      <img
                        src={conf.authorImage || b.image || undefined}
                        key={conf.authorImage || b.image || undefined}
                  ...
                  <input
                    type="text"
                    className="flex-1 text-xs p-3 border border-neutral-300"
                    value={conf.authorImage ?? ""}
